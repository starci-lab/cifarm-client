...
namespace CiFarm.RestApi
{
    public partial class RestApiClient
    {
        ...
        public async UniTask<CollectAnimalProductResponse> CollectAnimalProductAsync(
        ...
        public async UniTask<CureAnimalResponse> CureAnimalAsync(CureAnimalRequest request)
        {
        ...
        public async UniTask<FeedAnimalResponse> FeedAnimalAsync(FeedAnimalRequest request)
        {
        ...
        public async UniTask<HarvestCropResponse> HarvestCropAsync(HarvestCropRequest request)
        {
        ...
        public async UniTask<PlantSeedResponse> PlantSeedAsync(PlantSeedRequest request)
        {
        ...
        public async UniTask<UseFertilizerResponse> UseFertilizerAsync(UseFertilizerRequest request)
        {
        ...
        public async UniTask<UseHerbicideResponse> UseHerbicideAsync(UseHerbicideRequest request)
        {
        ...
        public async UniTask<UsePesticideResponse> UsePesticideAsync(UsePesticideRequest request)
        {
        ...
        public async UniTask<WaterResponse> WaterAsync(WaterRequest request)
        {
