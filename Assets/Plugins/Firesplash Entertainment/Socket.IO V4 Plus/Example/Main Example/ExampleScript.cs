...
public class ExampleScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        io.D.On(
            ...
            (sioEvent) =>
            {
                ...
                try
                {
                    ...
                    Debug.Log(
                        "Received the POD name from the server. Updating UI. Oh! It's "
        ...
        io.D.On<int[]>(
            ...
            {
                Debug.Log(
                    "We received the following numbers from the server: "
                        + string.Join(", ", numbers)
                );
                ...
                io.D.Emit(
                    ...
                    (rspPayload) =>
                    {
                        ...
                        Debug.Log(
                            "We received a response to the acknowledgement: " + rspPayload[0]
                        );
        ...
        io.D.On<byte[]>(
            ...
            (binData) =>
            {
                ...
                Debug.Log(
                    "We received the expected binary event from the server. The server said: "
                        + decodedString
                );
        ...
        io.D.On<string>(
            ...
            (payload) =>
            {
                ...
                {
                    Debug.LogWarning(
                        "We have been unexpecteldy disconnected. This will cause an automatic reconnect. Reason: "
                            + payload
                    );
                }
            }
